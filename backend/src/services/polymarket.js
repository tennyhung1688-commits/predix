...
const polymarketService = {
  ...
  // 批量获取事件标签并附加到市场
  async _attachEventTags(markets) {
  ...
  CATEGORIES: {
    ...
    politics:    { id: 2,     label: '政治',       slug: 'politics' },
    crypto:      { id: 21,    label: '加密货币',     slug: 'crypto' },
    weather:     { id: 84,    label: '天气',       slug: 'weather' },
    ...
    elections:   { id: 144,   label: '选举',       slug: 'elections' },
    ...
    commodities: { id: 101031, label: '大宗商品',  slug: 'commodities' },
    ...
    f1:          { id: 435,   label: 'F1',          slug: 'formula1' },
  },
